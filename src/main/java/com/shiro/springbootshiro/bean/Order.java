...
public class Order  implements Serializable{
	...
	public Order(String orderId, User orderUser, Date orderDate, Double orderPrice, Integer orderState,
	...
	public Order( User orderUser, Date orderDate, Double orderPrice, Integer orderState,
			String orderUserName, String orderPhone, String orderAddress) {
		super();
		this.orderUser = orderUser;
		this.orderDate = orderDate;
